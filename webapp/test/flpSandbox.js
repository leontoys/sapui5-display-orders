						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#DisplayOrders-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"DisplayOrders-display": {
								"semanticObject": "DisplayOrders",
								"action": "display",
								"description": "Projeto para estudo relacionado à criação de uma aplicação SAPUI5 para visualização de ordens de vendas.",
								"title": "Display Orders",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=displayorders",
									"url": sap.ui.require.toUrl("displayorders")
								}
							}
						}
					}
